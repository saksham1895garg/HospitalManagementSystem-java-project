...
| Member | Role | Modules |
|--------|------|---------|
| Avishi Mehorotra | Developer | Patient Management + Medical Records |
| Varista Gupta | Developer | Doctor Management + Appointments |
| Bhoomi Arora | Developer | Pharmacy + Billing |
| Saksham Garg | Developer | Admin + Dashboard + Reports |
